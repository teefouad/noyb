...
exports.applyDefaults = exports.deepCompare = exports.deepCopy = exports.mergeObjects = exports.queryObject = exports.findPropInObject = exports.findDirectPropInObject = exports.getObjectType = void 0;
...
var findDirectPropInObject = function findDirectPropInObject(obj, prop, copyByRef) {
  ...
  if (!copyByRef) {
    ...
    if (type === 'object') {
      result = (0, _extends4["default"])({}, obj);
    }
...
var queryObject = function queryObject(query, obj) {
  ...
  if (getObjectType(query) === 'object') {
    return Object.keys(query).reduce(function (prev, next) {
      ...
      return (0, _extends4["default"])({}, prev, (_extends2 = {}, _extends2[next] = findPropInObject(obj, query[next]), _extends2));
    }, {});
  }
...
var applyDefaults = function applyDefaults(settings, defaults) {
  ...
  return Object.keys(defaults).reduce(function (p, n) {
    ...
    return (0, _extends4["default"])({}, p, (_extends3 = {}, _extends3[n] = getObjectType(defaults[n]) === 'object' ? applyDefaults(settings[n], defaults[n]) : (_settings$n = settings[n]) != null ? _settings$n : defaults[n], _extends3));
  }, {});
};
